...
- Added TMDB season selection modal, improved season metadata handling, and added season selection to batch imports [#220](https://github.com/mProjectsCode/obsidian-media-db-plugin/pull/220) (thanks ltctceplrm)
...
- Fixed property mapping validation for mappings that conflict with existing property names
